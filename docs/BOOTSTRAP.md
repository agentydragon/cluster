...
**NEW**: All platform services deploy automatically via consolidated terraform with ESO secret generation.

Platform services (Vault, Authentik, Harbor, Gitea, Matrix) deploy automatically through the consolidated bootstrap process:
