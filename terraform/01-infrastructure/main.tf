...
# Note: Kubernetes, Helm, and Flux providers are configured dynamically by the infrastructure module
# They use the kubeconfig generated by Talos for cluster access
